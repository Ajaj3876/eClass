            ...
            <div class="container">
                ...
                <section id="content">
                  ...
                  <div align="center">
                        <hr size="1" width="50%" />
                        <br />
                       <h2 class="style8">Congrats !</h2> 
                       <h3>You are Successfully Registerd</h3> <br>

                       <%
                       String lastiInsertId=null;
                       try{
                        lastiInsertId= request.getParameter("lastiInsertId");
                    } catch(Exception e){
                     System.out.println(e);
                         }

                       %>
					   <h4> Your Enrollment no is : - <%=lastiInsertId%></h4>
                        <br />
                        <hr size="1" width="50%" />
						<span class="style10">Keep your Enrollment safe for future use </span><br>

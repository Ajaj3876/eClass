                ...
                <section id="content">
                    ...
                    <div align="center">
                        ...
                        <table width="476" border="1" cellspacing="0" cellpadding="0">
                            <tr>
                                <th colspan="3" scope="col"><div align="center"><span class="style13">Update Profile</span>	<br>
                                        &nbsp;</div></th>
                            </tr>
                            <%
                                        try {
                                            ...
                                            if (dbcon1.rst.next()) {
                            %>
							<form action="StuUpdateProfileServlet" method="post" enctype="multipart/form-data">
							                            <tr>
                              <th width="96" scope="row"><div align="right">Enrollment No. </div></th>
                              <td width="153"><div align="right"><input name="enroll" type="text" class="rowElem" value="<%=enroll%>" readonly="true">  </div></td>
                              <td width="219" rowspan="6"><input name="photo" type="file" class="rowElem"></td>
                            </tr>
                            <tr>
                                <th scope="row"><div align="right">Enroll Date </div></th>
                                <td><div align="right"><input name="enrol_date" type="text" class="rowElem" value="<%=dbcon1.rst.getString(1)%>" readonly="true"></div></td>
                            </tr>
                            <tr>
                                <th scope="row"><div align="right">Name</div></th>
                                <td><div align="right"><input name="sname" type="text" value="<%=dbcon1.rst.getString(2)%>"></div></td>
                            </tr>
                            <tr>
                                <th scope="row"><div align="right">Father Name </div></th>
                                <td><div align="right"><input name="fname" type="text" value="<%=dbcon1.rst.getString(3)%>"></div></td>
                            </tr>
                            <tr>
                                <th scope="row"><div align="right">Date of Birth </div></th>
                                <td><div align="right"><input name="dob" type="text" value="<%=dbcon1.rst.getString(4)%>"></div></td>
                            </tr>
                            <tr>
                                <th scope="row"><div align="right">Class</div></th>
                                <td><div align="right"><input name="clas" type="text" value="<%=dbcon1.rst.getString(5)%>"></div></td>
                            </tr>
                            <tr>
                                <th scope="row"><div align="right">College</div></th>
                                <td colspan="2"><div align="right"><input name="clg" type="text" value="<%=dbcon1.rst.getString(6)%>"></div></td>
                            </tr>
                            <tr>
                                <th scope="row"><div align="right">City</div></th>
                                <td colspan="2"><div align="right"><input name="city" type="text" value="<%=dbcon1.rst.getString(7)%>"></div></td>
                            </tr>
                            <tr>
                                <th scope="row"><div align="right">State</div></th>
                                <td colspan="2"><div align="right"><input name="state" type="text" value="<%=dbcon1.rst.getString(8)%>"></div></td>
                            </tr>
                            <tr>
                                <th scope="row"><div align="right">Country</div></th>
                                <td colspan="2"><div align="right"><input name="country" type="text" value="<%=dbcon1.rst.getString(9)%>"></div></td>
                            </tr>
                            <tr>
                                <th scope="row"><div align="right">Mobile</div></th>
                                <td colspan="2"><div align="right"><input name="mob" type="text" value="<%=dbcon1.rst.getString(10)%>"></div></td>
                            </tr>
                            <tr>
                                <th scope="row"><div align="right">Course</div></th>
                                <td colspan="2"><div align="right"><input name="course" type="text" value="<%=dbcon1.rst.getString(11)%>"></div></td>
                            </tr>
                            <tr>
                                <th scope="row"><div align="right">Email</div></th>
                                <td colspan="2"><div align="right"><input name="email" type="text" value="<%=dbcon1.rst.getString(12)%>"></div></td>
                            </tr>
                            <tr>
                                <th scope="row"><div align="right">Hint Question </div></th>
                                <td colspan="2"><div align="right"><input name="hq" type="text" value="<%=dbcon1.rst.getString(13)%>"></div></td>
                            </tr>
                            <tr>
                                <th scope="row"><div align="right">Hint Answer </div></th>
                                <td colspan="2"><div align="right"><input name="hs" type="text" value="<%=dbcon1.rst.getString(14)%>"></div></td>
                            </tr>
							<tr>
                                <th scope="row">&nbsp;</th>
                                <td colspan="2">&nbsp;</td>

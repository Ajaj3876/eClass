...
<html lang="en"><head>
    ...
    <body id="page1">
        <div align="center"><span class="style1">Not Approved Student List</span>    </div>
        <br>
        <table width="100%" border="1px" cellspacing="0" cellpadding="0">
            ...
            <%
                        try {
                            ...
                            db.rst = db.stmt.executeQuery("SELECT stu_mstr.enrol_no, stu_mstr.enrol_date, stu_mstr.sname, stu_mstr.f_name , stu_mstr.d_o_b, stu_mstr.clas, stu_mstr.College , stu_mstr.city, stu_mstr.country, stu_mstr.mob , stu_mstr.course FROM eclass.stu_login  INNER JOIN eclass.stu_mstr  ON (stu_login.enrol_no = stu_mstr.enrol_no) WHERE (stu_login.approval =0);");
                            while (db.rst.next()) {
            %>
            ...
            <form action="ApprovStuListServlt" method="post" name="frm">
                ...
                <input type="hidden" value="Apprvd" name="type">

            ...
            <div class="container">
                ...
                <section id="content">
                    ...
                    <div align="center">
                        <hr size="1" width="50%" />
                        <br />
                        <table width="428" border="1" cellspacing="0" cellpadding="0">
                            <tr>
                                <th colspan="3" scope="col"><div align="center"><span class="style13">Profile</span>	<br>
                                        &nbsp;</div></th>
                            </tr>
                            <%
                                        try {
                            ...
                            %>
                            <tr>
                              <th width="114" scope="row"><div align="right">Enrollment No. </div></th>
                              <td width="157"><div align="right"><%=enroll%>  </div></td>
                                <td width="149" rowspan="6"><img alt="" src="ImgDisp?enroll=<%=enroll%> " hspace="0px" vspace="0px" width="129" height="130" style="margin-left: 10px;margin-bottom: 5px;float: left; border:thin;background-color:#FF0000" /></td>
                            </tr>
                            <tr>
                                <th scope="row"><div align="right">Enrollment Date </div></th>
                                <td><div align="right"><%=dbcon1.rst.getString(1)%></div></td>
                            </tr>
                            <tr>
                                <th scope="row"><div align="right">Name</div></th>
                                <td><div align="right"><%=dbcon1.rst.getString(2)%></div></td>
                            </tr>
                            <tr>
                                <th scope="row"><div align="right">Father Name </div></th>
                                <td><div align="right"><%=dbcon1.rst.getString(3)%></div></td>
                            </tr>
                            <tr>
                                <th scope="row"><div align="right">Date of Birth </div></th>
                                <td><div align="right"><%=dbcon1.rst.getString(4)%></div></td>
                            </tr>
                            <tr>
                                <th scope="row"><div align="right">Class</div></th>
                                <td><div align="right"><%=dbcon1.rst.getString(5)%></div></td>
                            </tr>
                            <tr>
                                <th scope="row"><div align="right">College</div></th>
                                <td colspan="2"><div align="right"><%=dbcon1.rst.getString(6)%></div></td>
                            </tr>
                            <tr>
                                <th scope="row"><div align="right">City</div></th>
                                <td colspan="2"><div align="right"><%=dbcon1.rst.getString(7)%></div></td>
                            </tr>
                            <tr>
                                <th scope="row"><div align="right">State</div></th>
                                <td colspan="2"><div align="right"><%=dbcon1.rst.getString(8)%></div></td>
                            </tr>
                            <tr>
                                <th scope="row"><div align="right">Country</div></th>
                                <td colspan="2"><div align="right"><%=dbcon1.rst.getString(9)%></div></td>
                            </tr>
                            <tr>
                                <th scope="row"><div align="right">Mobile</div></th>
                                <td colspan="2"><div align="right"><%=dbcon1.rst.getString(10)%></div></td>
                            </tr>
                            <tr>
                                <th scope="row"><div align="right">Course</div></th>
                                <td colspan="2"><div align="right"><%=dbcon1.rst.getString(11)%></div></td>
                            </tr>
                            <tr>
                                <th scope="row"><div align="right">Email</div></th>
                                <td colspan="2"><div align="right"><%=dbcon1.rst.getString(12)%></div></td>
                            </tr>
                            <tr>
                                <th scope="row"><div align="right">Hint Question </div></th>
                                <td colspan="2"><div align="right"><%=dbcon1.rst.getString(13)%></div></td>
                            </tr>
                            <tr>
                                <th scope="row"><div align="right">Hint Answer </div></th>
                                <td colspan="2"><div align="right"><%=dbcon1.rst.getString(14)%></div></td>
                            </tr>
                            <tr>
                                <th scope="row">&nbsp;</th>
                                <td colspan="2">&nbsp;</td>

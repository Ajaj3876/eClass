<%-- 
    Document   : UserLogin
    Created on : Mar 12, 2024, 11:05:57 AM
    Author     : acer
--%>
...
<html lang="en"><head>
        ...
        <title>User - Login Page | E-Classroom's Site </title>
        <meta charset="utf-8">
        ...
        <div class="wrap">
            ...
            <div class="container">
                ...
                <section id="content">
                    ...
                    <div class="inside">
                        <p>
                        <h2 class="style2" style="float:left;margin-right:0px;">Login </h2></p>
                    ...
                    <div align="center">
                        ...
                        <br />
                        <form action="UserLoginServlet" method="post" name="frm" onSubmit="return validate();">
                            <table width="248" border="1" cellspacing="0" cellpadding="0" align="center" class="rowElem">
                                 <tr>
                                    <td width="100%" colspan="2">
                                        <input type="radio" name="role" value="stu" checked="checked" />Student &nbsp;
                                        <input type="radio" name="role" value="techr" />Teacher &nbsp;
								...
								<tr>
                                    <td><span class="txt1">User Name</span></td>
                        ...
                        <hr size="1" width="50%" />
                        <span class="style7">
                            <a href="">Forgot Password	</a></span>	</span> &nbsp;&nbsp;**&nbsp;Not Yet Registered <a href="studentRegister.jsp">Click Here</a>		</div>
                </section>
            </div>
        </div>
        <!-- footer -->

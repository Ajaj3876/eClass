                ...
                <section id="content">
                    ...
                    <div align="center">
                        ...
                        <form method="post" action="UpdateTeacherServlet">
                            <table width="600" border="1" cellspacing="0" cellpadding="0">
                                <tr>
                                    <th colspan="2" scope="col"><span class="style11">Update Teacher</span></th>
                                </tr>
                                <tr>
                                    <th scope="row"><input name="tid" type="hidden" value="<%=tid%>"></th>
                                    <td>&nbsp;</td>
                                </tr>
                                <tr>
                                    <th scope="row">Name</th>
                                    <td><input name="tname" type="text" value="<%=db.rst.getString(1)%>"></td>
                                </tr>
                                <tr>
                                    <th scope="row">Date of Joining</th>
                                    <td><input name="d_o_j" type="text" onfocus="scwShow(this,event);" onclick="scwShow(this,event);" value="<%=db.rst.getString(2)%>"></td>
                                </tr>
                                <tr>
                                    <th scope="row">Address</th>
                                    <td><input name="address" type="text" value="<%=db.rst.getString(3)%>"></td>
                                </tr>
                                <tr>
                                    <th scope="row">Qualification</th>
                                    <td><input name="qualifctn" type="text" value="<%=db.rst.getString(4)%>"></td>
                                </tr>
                                <tr>
                                    <th scope="row">University</th>
                                    <td><input name="university" type="text" value="<%=db.rst.getString(5)%>"></td>
                                </tr>
                                <tr>
                                    <th scope="row">Teaching Subject</th>
                                    <td><input name="course" type="text" value="<%=db.rst.getString(6)%>"></td>
                                </tr>
                                <tr>
                                    <th scope="row">Mobile</th>
                                    <td><input name="mob" type="text" value="<%=db.rst.getString(7)%>"></td>
                                </tr>
                                <tr>
                                    <th scope="row">Email</th>
                                    <td><input name="email" type="text" value="<%=db.rst.getString(8)%>"></td>
                                </tr>
                                <tr>
                                    <th scope="row">Password</th>
                                    <td><input name="pswd" type="text" id="pswd" value="<%=db.rst.getString(9)%>"></td>
                                </tr>
                                <tr>
                                    <th scope="row">&nbsp;</th>
                                    <td>&nbsp;</td>
